...
/***/ function(module, exports, __webpack_require__) {
	...
	var _strophe = __webpack_require__(160);

	var _strophe2 = _interopRequireDefault(_strophe);

	var _strophe3 = __webpack_require__(179);

	var _strophe4 = _interopRequireDefault(_strophe3);

	var _strophe5 = __webpack_require__(180);

	var _strophe6 = _interopRequireDefault(_strophe5);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	_reactDom2.default.render(_react2.default.createElement(_Layout2.default, null), document.querySelector('#wrapper'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _world = __webpack_require__(162);
	...
	var Layout = function (_React$Component) {
	  ...
	  function Layout(props) {
	    ...
	    _this.state = _world2.default.state;

	    _world2.default.onChange(function () {
	      return _this.setState(_world2.default.state);
	    });

	    window.addEventListener('resize', function () {
	      return _this.setState({ windowSize: _this._determineSize() });
	    });
	    _this.state.windowSize = _this._determineSize();
	    return _this;
	  }
	  ...
	  _createClass(Layout, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        this.state.register ? _react2.default.createElement(_Register2.default, this.state.register) : this._render()
	      );
	    }
	  }, {
	    key: '_render',
	    value: function _render() {
	      switch (this.state.connection.status) {
	        case Strophe.Status.ERROR:
	          return _react2.default.createElement(_Connect2.default, _extends({}, this.state, { error: "Something went wrong. Not sure what." }));
	        ...
	        case Strophe.Status.AUTHFAIL:
	          return _react2.default.createElement(_Connect2.default, _extends({}, this.state, { error: "Authentication failed!" }));
	        case Strophe.Status.CONNECTED:
	          return _react2.default.createElement(_Main2.default, this.state);
	        case Strophe.Status.DISCONNECTED:
	        case Strophe.Status.DISCONNECTING:
	        case undefined:
	          return _react2.default.createElement(_Connect2.default, this.state);
	        default:
	          return _react2.default.createElement(
	            'strong',
	            null,
	    ...
	    value: function updateStatus(status) {
	      _Dispatcher2.default.dispatch('update-connection', 'status', status);
	      if (status == Strophe.Status.CONNECTED) {
	        this.connection.send($pres());
	        _Dispatcher2.default.dispatch('connection', this.connection);
	      }
	    }
	  }, {
	    key: 'addMessage',
	    ...
	    key: '_css',
	    value: function _css() {
	      var _state$windowSize = this.state.windowSize;
	      var height = _state$windowSize.height;
	      var width = _state$windowSize.width;

	      return ['#sidebar, #chat { height: ' + height + 'px; }', '#connect, #register { margin-top: ' + (height / 2 - 160) + 'px; }'].join('\n');
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Main = function (_React$Component) {
	  ...
	  function Main(props) {
	    ...
	    _this.state = {
	      roster: _world2.default.roster.state,
	      privateChats: _world2.default.privateChats
	    };

	    _this._updateRoster = _this._updateRoster.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(Main, [{
	    ...
	    value: function componentDidMount() {
	      _world2.default.roster.onChange(this._updateRoster);
	    }
	  }, {
	    key: 'componentWillUnmount',
	    value: function componentWillUnmount() {
	      _world2.default.roster.removeChangeHandler(this._updateRoster);
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      var chat = _world2.default.privateChats.getChat(this.state.roster.selected);
	      var peerPresence = chat && this._getPresence(chat.jid);
	      return _react2.default.createElement(
	        'div',
	        { id: 'main' },
	        _react2.default.createElement(_SideBar2.default, this.state),
	        chat && _react2.default.createElement(_Chat2.default, _extends({}, chat, { presence: peerPresence }))
	      );
	    }
	  }, {
	    key: '_updateRoster',
	    value: function _updateRoster() {
	      this.setState({ roster: _world2.default.roster.state });
	    }
	  }, {
	    key: '_getPresence',
	    value: function _getPresence(jid) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ConnectionStore = __webpack_require__(163);

	var _ConnectionStore2 = _interopRequireDefault(_ConnectionStore);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var world = new _ConnectionStore2.default(msgcatConfig);
	window.world = world;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BasicStore2 = __webpack_require__(165);

	var _BasicStore3 = _interopRequireDefault(_BasicStore2);

	var _RosterStore = __webpack_require__(166);

	var _RosterStore2 = _interopRequireDefault(_RosterStore);

	var _ChannelsStore = __webpack_require__(168);

	var _ChannelsStore2 = _interopRequireDefault(_ChannelsStore);

	var _PrivateChatsStore = __webpack_require__(169);

	var _PrivateChatsStore2 = _interopRequireDefault(_PrivateChatsStore);
	...
	var ConnectionStore = function (_BasicStore) {
	  _inherits(ConnectionStore, _BasicStore);

	  function ConnectionStore(config) {
	    _classCallCheck(this, ConnectionStore);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ConnectionStore).call(this, {
	      connection: {
	    ...
	    _this._setupSubStores();

	    // TODO: dispatch this from the real "world" (which controls the layout)!
	    if (_this.state.connection.status == Strophe.Status.CONNECTED || _this.state.connection.status == Strophe.Status.CONNECTING) {
	      _this.state.connection.status = Strophe.Status.CONNECTING;
	      _Dispatcher2.default.dispatchLater('connect');
	    }

	    if (_this.state.register && _this.state.register.error) {
	      delete _this.state.register.error;
	    }

	    _Dispatcher2.default.register('update-connection', function (key, value) {
	      _this.state.connection[key] = value;
	      _this._changed();
	    });

	    _Dispatcher2.default.register('connect', function (key, value) {
	      _this.connection = new Strophe.Connection(_this.state.connection.boshService);
	      _this.connection.addHandler(function (stanza) {
	        console.log('stanza', stanza);
	        return true;
	      });
	      _this.connection.connect(_this.state.connection.jid, _this.state.connection.password, function (status) {
	        return _this._updateStatus(status);
	      });
	    });

	    _Dispatcher2.default.register('disconnect', function () {
	      _this.state.connection.jid = '';
	      _this.state.connection.password = '';
	      _this._changed();
	      _this.roster.purgeAndReset();
	      _this.channels.purgeAndReset();
	      _this.privateChats.purgeAndReset();
	      _this.connection.disconnect();
	    });

	    _Dispatcher2.default.register('go-register', function () {
	    ...
	    _Dispatcher2.default.register('go-connect', function () {
	      _this.state.register = undefined;
	      _this._changed();
	    });

	    _Dispatcher2.default.register('update-registration', function (key, value) {
	      _this.state.register[key] = value;
	      _this._changed();
	    });

	    _Dispatcher2.default.register('register', function () {
	      var reg = _this.state.register;
	      ...
	      _this.connection.register.connect(reg.host, function (status) {
	        console.log('reg status', toStatusString(status));
	        var error = void 0;
	        if (status === Strophe.Status.REGISTER) {
	          _this.connection.register.fields.username = reg.username;
	          _this.connection.register.fields.password = reg.password;
	          _this.connection.register.submit();
	        } else if (status === Strophe.Status.REGISTERED) {
	          _this.state.connection.jid = reg.username + '@' + reg.host;
	          _this.state.connection.error = '';
	          _this.state.register = undefined;
	          _this._changed();
	  ...
	  _createClass(ConnectionStore, [{
	    ...
	    value: function _updateStatus(status) {
	      _Dispatcher2.default.dispatchLater('update-connection', 'status', status);
	      if (status == Strophe.Status.CONNECTED) {
	        this.connection.send($pres());
	    ...
	    key: '_setupSubStores',
	    value: function _setupSubStores() {
	      this.roster = new _RosterStore2.default(this);
	      this.channels = new _ChannelsStore2.default(this);
	      this.privateChats = new _PrivateChatsStore2.default(this);
	    }
	  }]);

	  return ConnectionStore;
	}(_BasicStore3.default);

	exports.default = ConnectionStore;


	function toStatusString(status) {
	  for (var name in Strophe.Status) {
...
/***/ function(module, exports) {
	...
	exports.default = {
	  ...
	  dispatchLater: function dispatchLater() {
	    var _this = this;
...
/***/ function(module, exports) {
	...
	var BasicStore = function () {
	  function BasicStore(initialState, key) {
	  ...
	  _createClass(BasicStore, [{
	    ...
	    value: function removeChangeHandler(handler) {
	      this._changeHandlers = this._changeHandlers.filter(function (h) {
	        return h !== handler;
	      });
	    }
	  }, {
	    key: "purgeAndReset",
	    value: function purgeAndReset() {
	      if (this.key) {
	    ...
	    value: function _changed() {
	      ...
	      this._changeHandlers.forEach(function (h) {
	        return h();
	      });
	    }
	  }, {
	    key: "_loadState",
	    value: function _loadState() {
	      var data = void 0;
	      try {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RosterStore = function (_BasicStore) {
	  _inherits(RosterStore, _BasicStore);

	  function RosterStore(world) {
	    _classCallCheck(this, RosterStore);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(RosterStore).call(this, {
	    ...
	    _Dispatcher2.default.register('switch-to', function (jid) {
	      _this.state.selected = jid;
	      _this._changed();
	    });

	    _Dispatcher2.default.register('subscribe-contact', function (jid) {
	      return _this.addContact(jid);
	    });
	    _Dispatcher2.default.register('set-my-presence', function (show) {
	      return _this.setMyPresence(show);
	    });
	    _Dispatcher2.default.register('accept-subscription', function (jid) {
	      return _this.acceptSubscription(jid);
	    });
	    _Dispatcher2.default.register('reject-subscription', function (jid) {
	      return _this.rejectSubscription(jid);
	    });
	    return _this;
	  }
	  ...
	  _createClass(RosterStore, [{
	    ...
	    value: function setConnection(connection) {
	      ...
	      this.state.me.jid = _util2.default.bareJID(connection.jid);
	      this.state.me.resource = _util2.default.resourceFromJID(connection.jid);
	      this.setMyPresence(this.state.me.presence);
	      if (this.state.selected) {
	        _Dispatcher2.default.dispatchLater('switch-to', this.state.selected);
	      }
	    }
	    ...
	    key: 'setMyPresence',
	    value: function setMyPresence(show) {
	      this.state.me.presence = show;
	      if (show === 'available') {
	        show = '';
	      }
	      var update = $pres().c('show').t(show).up().tree();
	    ...
	    key: 'acceptSubscription',
	    value: function acceptSubscription(jid) {
	    ...
	    value: function rejectSubscription(jid) {
	    ...
	    value: function removeSubscription(jid) {
	      this.state.subscriptions = this.state.subscriptions.filter(function (sub) {
	        return sub.jid !== jid;
	      });
	      this._changed();
	    }
	    ...
	    key: '_rosterChanged',
	    value: function _rosterChanged(items) {
	      this.state.privateChats = items;
	      this._changed();
	    }
	  }, {
	    key: '_onPresence',
	    value: function _onPresence(presence) {
	      try {
	        ...
	        switch (type) {
	          case 'subscribe':
	            this.state.subscriptions.push({
	              from: _util2.default.bareJID(from)
	            });
	            break;
	          case 'error':
	            break;
	          default:
	            var pres = this.state.presence[_util2.default.bareJID(from)];
	            if (!pres) {
	              pres = {};
	            }
	            var showElement = presence.getElementsByTagName('show')[0];
	            pres.show = showElement ? showElement.textContent || 'available' : 'unavailable';
	            this.state.presence[_util2.default.bareJID(from)] = pres;
	        }
	        this._changed();
	      } catch (e) {
	        console.error(e);
...
/***/ function(module, exports) {
	...
	exports.default = {
	  bareJID: function bareJID(jid) {
	    return jid.split('/')[0];
	  },
	  resourceFromJID: function resourceFromJID(jid) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ChannelsStore = function (_BasicStore) {
	  _inherits(ChannelsStore, _BasicStore);

	  function ChannelsStore(world) {
	    _classCallCheck(this, ChannelsStore);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ChannelsStore).call(this, {}));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PrivateChatsStore = function (_BasicStore) {
	  _inherits(PrivateChatsStore, _BasicStore);

	  function PrivateChatsStore(world) {
	    _classCallCheck(this, PrivateChatsStore);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(PrivateChatsStore).call(this, {
	      chats: {}
	    }));

	    _this.world = world;
	    _Dispatcher2.default.register('switch-to', function (jid) {
	      var chat = _this.getChat(jid);
	      if (!chat.loaded) {
	        _this._loadBacklog(jid);
	      }
	    });

	    _Dispatcher2.default.register('update-draft', function (jid, draft) {
	      _this.getChat(jid).draft = draft;
	      _this._changed();
	    });

	    _Dispatcher2.default.register('send-draft', function (jid) {
	      var chat = _this.getChat(jid);
	      if (chat.draft.length > 0) {
	        _this.connection.send($message().c('body').t(chat.draft).up().tree());
	        chat.draft = '';
	        _this._changed();
	      }
	    });
	  ...
	  _createClass(PrivateChatsStore, [{
	    key: 'setConnection',
	    value: function setConnection(connection) {
	      this.connection = connection;
	    ...
	    value: function getChat(jid) {
	      ...
	      if (!this.state.chats[jid]) {
	        var chat = { jid: jid, messages: [], draft: '' };
	    ...
	    value: function _onMessage(message) {
	      var from = util.bareJID(message.getAttribute('from'));
	      var chat = this.getChat(from);
	      // TODO:
	      //   - fetch body
	      //   - get chat state
	    ...
	    key: '_loadBacklog',
	    value: function _loadBacklog(jid) {
	      // TODO: load backlog from message archives!
	    }
	  }]);

	  return PrivateChatsStore;
	}(_BasicStore3.default);

	exports.default = PrivateChatsStore;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PrivateChats = __webpack_require__(171);

	var _PrivateChats2 = _interopRequireDefault(_PrivateChats);

	var _Subscriptions = __webpack_require__(172);

	var _Subscriptions2 = _interopRequireDefault(_Subscriptions);

	var _ConnectionInfo = __webpack_require__(173);
	  ...
	  _createClass(SideBar, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { id: 'sidebar' },
	        _react2.default.createElement(_ConnectionInfo2.default, roster.me),
	        _react2.default.createElement(_PrivateChats2.default, { items: roster.privateChats,
	          presence: roster.presence,
	          selected: roster.selected }),
	        _react2.default.createElement(_Subscriptions2.default, { items: roster.subscriptions })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PrivateChats = function (_React$Component) {
	  _inherits(PrivateChats, _React$Component);

	  function PrivateChats(props) {
	    _classCallCheck(this, PrivateChats);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(PrivateChats).call(this, props));
	  ...
	  _createClass(PrivateChats, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: 'private-chats' },
	        _react2.default.createElement(
	          'h3',
	          null,
	          'Private Chats',
	          _react2.default.createElement('a', { className: 'add-contact', onClick: function onClick() {
	              return _this2.setState({ add: true });
	            },
	            title: 'Add Contact' })
	        ),
	    ...
	    value: function _renderItem(item) {
	      return _react2.default.createElement(
	        'li',
	        { className: 'channel channel-private',
	          ...
	          onClick: function onClick() {
	            return _Dispatcher2.default.dispatch('switch-to', _util2.default.bareJID(item.jid));
	          } },
	        _react2.default.createElement('span', { className: 'presence-icon' }),
	        item.name ? item.name : item.jid
	      );
	    }
	  }, {
	    key: '_renderSubscribeForm',
	    value: function _renderSubscribeForm() {
	      var _this3 = this;

	      return _react2.default.createElement(
	        'form',
	        { className: 'subscribe-form', onSubmit: function onSubmit(e) {
	            return _this3._handleSubmit(e);
	          } },
	        _react2.default.createElement('input', { type: 'text', ref: 'addContactInput', autoComplete: 'off' }),
	        _react2.default.createElement(
	          'button',
	          { type: 'submit' },
	          'Subscribe'
	    ...
	    value: function _handleSubmit(e) {
	      e.preventDefault();
	      var jid = this.refs.addContactInput.value;
	      this.setState({ add: false });
	      _Dispatcher2.default.dispatch('subscribe-contact', jid);
	    }
	  }, {
	    key: '_jidPresence',
	    value: function _jidPresence(jid) {
	      var pres = this.props.presence[_util2.default.bareJID(jid)];
	      var show = pres ? pres.show : 'unavailable';
	      return show;
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Subscriptions = function (_React$Component) {
	  ...
	  _createClass(Subscriptions, [{
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'tbody',
	            null,
	            this.props.items.map(function (sub) {
	              return _this2._renderSub(sub);
	            })
	          )
	        )
	      );
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'button',
	            { onClick: function onClick() {
	                return _this3._acceptSub(sub.from);
	              } },
	            'Accept'
	          )
	        ),
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'button',
	            { onClick: function onClick() {
	                return _this3._rejectSub(sub.from);
	              } },
	            'Reject'
	          )
	        )
	    ...
	    key: '_acceptSub',
	    value: function _acceptSub(jid) {
	      _Dispatcher2.default.dispatch('accept-subscription', jid);
	    }
	  }, {
	    key: '_rejectSub',
	    value: function _rejectSub(jid) {
	      _Dispatcher2.default.dispatch('reject-subscription', jid);
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ConnectionInfo = function (_React$Component) {
	  _inherits(ConnectionInfo, _React$Component);

	  function ConnectionInfo(props) {
	    _classCallCheck(this, ConnectionInfo);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ConnectionInfo).call(this, props));
	  ...
	  _createClass(ConnectionInfo, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: 'connection-info', 'data-dropdown': this.state.dropdown },
	        _react2.default.createElement(
	          'h3',
	          null,
	          this.props.presence === 'away' ? '(' + this.props.jid + ')' : this.props.jid,
	          _react2.default.createElement('span', { className: 'dropdown-control', onClick: function onClick() {
	              return _this2.setState({
	                dropdown: !_this2.state.dropdown });
	            } })
	        ),
	    ...
	    key: '_renderSetAwayItem',
	    value: function _renderSetAwayItem() {
	      var label = void 0,
	          value = void 0;
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: 'dropdown-item', onClick: this._itemHandler('set-my-presence', value) },
	        label
	      );
	    }
	  }, {
	    key: '_renderDisconnectItem',
	    value: function _renderDisconnectItem() {
	      return _react2.default.createElement(
	        'div',
	        { className: 'dropdown-item', onClick: this._itemHandler('disconnect') },
	        'Disconnect'
	      );
	    }
	  }, {
	    key: '_itemHandler',
	    value: function _itemHandler(action) {
	      var _this3 = this;
	      ...
	      return function () {
	        _this3.setState({ dropdown: false });
	        _Dispatcher2.default.dispatch.apply(_Dispatcher2.default, [action].concat(args));
	      };
	    }
	  }]);
	...
	exports.default = ConnectionInfo;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MessageDraft = __webpack_require__(175);

	var _MessageDraft2 = _interopRequireDefault(_MessageDraft);

	var _ChatMessage = __webpack_require__(176);
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          null,
	          this.props.jid,
	          presenceHint && _react2.default.createElement(
	            'div',
	            { className: 'presence-hint' },
	            presenceHint
	          )
	        ),
	        _react2.default.createElement(
	          ...
	          this.props.messages.forEach(function (m, i) {
	            return _react2.default.createElement(_ChatMessage2.default, _extends({}, m, { key: i }));
	          })
	        ),
	        _react2.default.createElement(_MessageDraft2.default, { draft: this.props.draft })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MessageDraft = function (_React$Component) {
	  _inherits(MessageDraft, _React$Component);

	  function MessageDraft(props) {
	    _classCallCheck(this, MessageDraft);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(MessageDraft).call(this, props));

	    _this.state = {};
	    return _this;
	  }

	  _createClass(MessageDraft, [{
	    key: 'render',
	    value: function render() {
	      var _this2 = this;
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('input', { type: 'text', autoComplete: 'off', value: this.props.draft, onChange: function onChange(e) {
	    ...
	    value: function handleSubmit(e) {
	      e.preventDefault();
	      _Dispatcher2.default.dispatch('send-draft', this.props.jid);
	    }
	  }, {
	    key: 'handleChange',
	    value: function handleChange(e) {
	      _Dispatcher2.default.dispatch('update-draft', this.props.jid, e.target.value);
	    }
	  }]);
	  ...
	  _createClass(Register, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'form',
	          { className: 'register-form', onSubmit: function onSubmit(e) {
	              return _this2.handleSubmit(e);
	            } },
	          _react2.default.createElement(
	            'div',
	            ...
	            _react2.default.createElement(
	              'label',
	              { htmlFor: '#register-host' },
	              'Host'
	            ),
	            _react2.default.createElement('input', { type: 'text', id: 'register-host', value: this.props.host,
	              autoFocus: true,
	              onChange: function onChange(e) {
	                return _this2.handleChange('host', e);
	              } })
	          ),
	          _react2.default.createElement(
	            'div',
	            ...
	            _react2.default.createElement('input', { type: 'text', id: 'register-username', value: this.props.username,
	              autoFocus: true,
	              onChange: function onChange(e) {
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement('input', { type: 'password', id: 'register-password', value: this.props.password,
	              onChange: function onChange(e) {
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement('input', { type: 'password', id: 'register-password-confirmation', value: this.props.passwordConfirmation,
	              onChange: function onChange(e) {
	                return _this2.handleChange('passwordConfirmation', e);
	              } })
	          ),
	          _react2.default.createElement(
	            'div',
	            ...
	            _react2.default.createElement(
	              'button',
	              { className: 'connect', type: 'button', onClick: function onClick(e) {
	            ...
	            _react2.default.createElement(
	              'button',
	              { className: 'register', type: 'submit' },
	              'Register'
	            )
	          )
	        )
	    ...
	    value: function handleSubmit(e) {
	      e.preventDefault();
	      _Dispatcher2.default.dispatch('register');
	    }
	  }, {
	    key: 'handleChange',
	    value: function handleChange(key, event) {
	      _Dispatcher2.default.dispatch('update-registration', key, event.target.value);
	    }
	  }, {
	    key: 'handleRegister',
	    value: function handleRegister(e) {
	      e.preventDefault();
	      _Dispatcher2.default.dispatch('go-connect');
	    }
	  }]);
	  ...
	  _createClass(Connect, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'form',
	          { className: 'connect-form', onSubmit: function onSubmit(e) {
	              return _this2.handleSubmit(e);
	            } },
	          _react2.default.createElement(
	            'div',
	            ...
	            _react2.default.createElement('input', { type: 'email', id: 'connect-jid', value: this.props.connection.jid,
	              autoFocus: true,
	              onChange: function onChange(e) {
	                return _this2.handleChange('jid', e);
	              } })
	          ),
	          _react2.default.createElement(
	            'div',
	            ...
	            _react2.default.createElement('input', { type: 'password', id: 'connect-password', value: this.props.connection.password,
	              onChange: function onChange(e) {
	                return _this2.handleChange('password', e);
	              } })
	          ),
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'button',
	              { className: 'register', type: 'button', onClick: function onClick(e) {
	                  return _this2.handleRegister(e);
	                } },
	    ...
	    value: function handleSubmit(e) {
	      e.preventDefault();
	      _Dispatcher2.default.dispatch('connect');
	    }
	  }, {
	    key: 'handleChange',
	    value: function handleChange(key, event) {
	      _Dispatcher2.default.dispatch('update-connection', key, event.target.value);
	    }
	  }, {
	    key: 'handleRegister',
	    value: function handleRegister(e) {
	      e.preventDefault();
	      _Dispatcher2.default.dispatch('go-register');
	    }
	  }]);
